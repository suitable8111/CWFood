...
static NSInteger const CLCalendarDayTitleTextColorDefault = 0xFFFFFF;
static NSString* const CLCalendarSelectedDatePrintFormatDefault = @"EEE, d MMM yyyy";
static float const CLCalendarSelectedDatePrintFontSizeDefault = 14.f;
